...
<iframe width="560" height="315" src="https://www.youtube.com/embed/r_gp_SJkJFs?si=RcvVsjsAkhjhGogg" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
...
## Overview
<img src="../assets/images/Nuclear Family/NFProgressGIF.gif" alt="Progress GIF" style="float: left; margin: 0 0 1em 1em; width: 400px; height: 400px; border-radius: 10px;">
...
![Layout Diagram](<../assets/images/Nuclear Family/NFLayoutDiagram.png>){: align-right}
### Wireframe
![NFWireframe](<../assets/images/Nuclear Family/NFWireframe.png>){: align-left}